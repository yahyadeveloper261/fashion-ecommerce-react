...
export default function Accessories({ dark }) {
...
const accessoriesProducts = filterSearch.filter(
...
return (
 <div
  ...
  <select
    ...
    className={`my-2 w-44 appearance-none rounded-xl px-4 py-2 pr-9 text-sm font-medium shadow-sm transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-pink-400/30 ${
      dark
        ...
        : "bg-blue-500  text-white border border-gray-200 hover:border-pink-400"
    }`}
  >
  ...
  {/* Sticky Categories */}
  <div
    className={`sticky top-28 z-40 py-2 ${
  ...
  >
    ...
    >
      ...
      {/* T-Shirts */}
      <button
        onClick={() => navigate("/accessories/t-shirts")}
        className={`shrink-0 px-4 py-2 rounded-full ${
      ...
      {/* Shirts */}
      <button
        onClick={() => navigate("/accessories/shirts")}
        className={`shrink-0 px-4 py-2 rounded-full ${
          subCategory === "shirts"
            ? "bg-blue-500  text-white"
            : dark
      ...
      {/* Jeans */}
      <button
        onClick={() => navigate("/accessories/jeans")}
        className={`shrink-0 px-4 py-2 rounded-full ${
          subCategory === "jeans"
            ? "bg-blue-500 text-white"
            : dark
      ...
      {/* Trousers */}
      <button
        onClick={() => navigate("/accessories/trousers")}
        className={`shrink-0 px-4 py-2 rounded-full ${
      ...
      {/* Hoodies */}
      <button
        onClick={() => navigate("/accessories/hoodies")}
        className={`shrink-0 px-4 py-2 rounded-full ${
          subCategory === "hoodies"
            ? "bg-blue-500  text-white"
            : dark
      ...
      {/* Jackets */}
      <button
        onClick={() => navigate("/accessories/jackets")}
        className={`shrink-0 px-4 py-2 rounded-full ${
          subCategory === "jackets"
            ? "bg-blue-500  text-white"
            : dark
      ...
      {/* Blazers */}
      <button
        onClick={() => navigate("/accessories/blazers")}
        className={`shrink-0 px-4 py-2 rounded-full ${
          subCategory === "blazers"
            ? "bg-blue-500  text-white"
            : dark
    ...
    filterSearch.length !== 0 && (
      <div className="col-span-full flex justify-center items-center py-16 px-4">
        <div className="text-center animate-pulse">
          ...
          >
            No {subCategory || "accessories products"} Available
          </h2>
